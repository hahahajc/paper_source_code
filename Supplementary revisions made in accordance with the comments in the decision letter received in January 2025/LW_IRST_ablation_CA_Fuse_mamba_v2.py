...
class LW_IRST_ablation_CA_Fuse_mamba_v2(nn.Module):
...
if __name__ == '__main__':
    ...
    model = LW_IRST_ablation_CA_Fuse_mamba_v2(channel=(8, 32, 64), dilations=(2,4,8,16), kernel_size=(7,7,7,7), padding=(3,3,3,3)).cuda() # kernel_size/padding = 5/2 7/3 9/4
    out = model(inputs)
